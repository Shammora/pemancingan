        ...
        <div class="row" style="justify-content: center">
            <div class="card border-primary">
                <div class="card-body text-primary">
                    <div class="row">
                        <img src="{{ asset('foto/' . $detail->gambar) }}" alt="Gambar" class="responsive-image"
                ...
                <div class="card border-primary">
                    <div class="card-body text-primary">
                        <form action="{{ route('pemancing.addRating') }}" method="POST">
                            ...
                            <div class="komen">
                                <label>Ulasan : </label>
                                <textarea name="komentar" id="komentar" cols="4" rows="2" class="form-control" required></textarea>
                            </div>
