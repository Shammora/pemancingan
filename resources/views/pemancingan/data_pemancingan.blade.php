                        ...
                        <table class="table table-bordered table-striped" id="data-pemancing">
                            ...
                            <tbody>
                                @foreach (@$pemancingan as $key => $value)
                                    <tr>
                                        <td>{{ @$value->id }}</td>
                                        <td><img class="zoom" src="{{ asset('foto/' . @$value->gambar) }}"></td>
                                        <td>{{ @$value->nama }}</td>
                ...
                <div class="modal-body">
                    <form action="{{ route('pemancingan.addPemancingan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="form-control" cols="4" rows="2" required></textarea>
                        </div>
                        <div class="form-group has-feedback">
                            <label>Alamat :</label>
    ...
    <div class="modal fade" id="modal-form-edit-pemancing" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('pemancingan.updatePemancingan') }}" method="post"
