...
<body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <a href="/pemancingan/home" class="logo">
                <span class="logo-mini"><b>PEMANCINGAN</b></span>
                <span class="logo-lg"><b>PEMANCINGAN</b></span>
            </a>
        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu">
                    <li>
                        <a href="{{ route('pemancingan.index') }}">
                            <i class="fa fa-home"></i> <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pemancingan.dataPemancingan') }}">
                            <i class="fa fa-list-alt"></i> <span>Data Pemancingan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pemancingan.dataJadwal') }}">
                            <i class="fa fa-list-alt"></i> <span>Data Jadwal</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pemancingan.profile') }}">
