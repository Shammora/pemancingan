            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Data Pemilik Pemancingan</h3>
                        ...
                        <table class="table table-bordered table-striped" id="data-pemancing">
                            ...
                            <tbody>
                                @foreach (@$pemilik as $key => $value)
                                    <tr>
                                        <td>{{ @$value->id }}</td>
                                        <td><img class="zoom" src="{{ asset('foto/' . @$value->foto) }}"></td>
                                        <td>{{ @$value->name }}</td>
                                        <td>{{ @$value->email }}</td>
                                        ...
                                        <td>
                                            {{-- <button class="btn btn-xs btn-success btn-edit-pemancing"><i class="fa fa-edit">
                                                    Ubah</i></button> &nbsp; --}}
                                            <a href="{{ route('admin.deletePemilik', @$value->id) }}"><button
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.addPemilik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group has-feedback">
                            <label>Alasan :</label>
                            <textarea name="keterangan" id="keterangan" class="form-control" cols="4" rows="2" required></textarea>
                        </div>
                        <div class="form-group has-feedback">
                            <label>Foto Proofile :</label>
    ...
    <div class="modal fade" id="modal-form-edit-pemancing" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.updatePemilik') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group has-feedback">
